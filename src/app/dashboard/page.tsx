...
/* Premium responsive dashboard polish — added for DropClarity */
:root{
  --dc-shell-max: 1580px;
  --dc-shell-pad: clamp(14px, 2.8vw, 42px);
  --dc-soft-shadow: 0 22px 70px rgba(15,23,42,.075);
  --dc-hover-shadow: 0 26px 80px rgba(15,23,42,.11);
  --dc-border: rgba(15,23,42,.085);
}
html{-webkit-text-size-adjust:100%;text-size-adjust:100%;scroll-behavior:smooth}body{overflow-x:hidden}button,input,select,textarea{font:inherit;-webkit-tap-highlight-color:transparent}button,a,input,select,textarea{touch-action:manipulation}
.dc-bg{padding:clamp(24px,4vw,58px) 0 clamp(28px,4vw,44px);background:radial-gradient(900px 420px at 7% -6%,rgba(124,58,237,.105),transparent 64%),radial-gradient(820px 440px at 93% 2%,rgba(34,211,238,.105),transparent 62%),radial-gradient(720px 380px at 52% 108%,rgba(16,185,129,.075),transparent 70%),linear-gradient(180deg,#fff 0%,#fbfdff 48%,#fff 100%)!important}.wrap{width:min(var(--dc-shell-max),calc(100vw - var(--dc-shell-pad) * 2));max-width:var(--dc-shell-max);padding:0}.topbar{align-items:center;margin-bottom:18px;padding:2px 2px 0}.dashboardIntro{max-width:980px}.pageKicker{padding:7px 12px;border-color:rgba(34,211,238,.26);background:rgba(255,255,255,.78);box-shadow:0 12px 32px rgba(34,211,238,.10)}.pageTitle{font-size:clamp(34px,3.05vw,56px);max-width:1020px;letter-spacing:-.055em}.pageSub{max-width:920px;font-size:clamp(15px,1.08vw,18px)}.statusRow{gap:9px}.pill,.btn,.rangeBtn,.miniBtn,.tag{min-height:38px}.btn,.rangeBtn,.miniBtn,.crumbBtn,.deleteReportBtn{transition:transform .16s ease,box-shadow .16s ease,border-color .16s ease,background .16s ease,opacity .16s ease}.btn:active,.rangeBtn:active,.miniBtn:active,.crumbBtn:active,.deleteReportBtn:active{transform:translateY(0) scale(.985)}.btn-primary{background:linear-gradient(90deg,rgba(34,211,238,.20),rgba(124,58,237,.18));box-shadow:0 12px 34px rgba(124,58,237,.08)}
.panel,.hero,.jobHero,.scalePanel,.chartCard,.kpi,.stat,.scaleCard,.item,.reportsSummaryCard,.creditKpiPanel{border-color:var(--dc-border)!important;box-shadow:var(--dc-soft-shadow)!important}.panel,.hero,.jobHero,.scalePanel{border-radius:28px;background:rgba(255,255,255,.86)}.panelHead{padding:clamp(16px,1.35vw,22px) clamp(16px,1.5vw,24px) 15px;background:linear-gradient(180deg,rgba(255,255,255,.96),rgba(248,250,252,.76))}.panelTitle,.chartTitle{letter-spacing:-.035em}.panelSub,.chartSub,.heroSub,.jobHeroSub,.scaleText{color:rgba(51,65,85,.68)!important}.pad{padding:clamp(14px,1.35vw,22px)}.rangeWrap,.marginTargetTopWrap{border-radius:24px;box-shadow:0 18px 52px rgba(15,23,42,.065);background:rgba(255,255,255,.82);backdrop-filter:blur(16px)}.rangeRight,.rangeButtons{min-width:0}.rangeBtn.active{background:linear-gradient(135deg,#0f172a,#1e293b);box-shadow:0 14px 38px rgba(15,23,42,.18)}.searchInput,.selectInput,.customDates input,.cellEdit,.compactTargetInputGroup{min-height:44px}
.heroBody,.jobHeroBody{padding:clamp(18px,1.65vw,28px);grid-template-columns:minmax(0,1.25fr) minmax(320px,.75fr);gap:clamp(14px,1.5vw,22px)}.heroTitle,.jobHeroTitle{font-size:clamp(28px,2.1vw,40px)}.summaryCard,.jobSummaryCard{border-radius:22px;background:linear-gradient(180deg,rgba(255,255,255,.94),rgba(248,250,252,.84))}.kpis{grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;padding:clamp(14px,1.35vw,22px)}.kpi,.stat,.creditKpiCard,.mixRow{border-radius:20px;background:linear-gradient(180deg,rgba(255,255,255,.96),rgba(248,250,252,.78))}.kpi:hover,.stat:hover,.chartCard:hover,.scaleCard:hover,.item:hover{transform:translateY(-1px);box-shadow:var(--dc-hover-shadow)!important}.kValue,.statValue{font-size:clamp(20px,1.4vw,27px)}
.charts,.jobCharts{gap:14px}.chartCard{border-radius:24px;padding:clamp(14px,1.35vw,22px)}.chartCard canvas{min-height:220px}.gridMix{grid-template-columns:repeat(4,minmax(0,1fr))}.mixRow{min-height:112px}.scalePanel{margin-top:16px}.scaleCommandGrid,.scaleGrid,.scaleGridPremiumV2{gap:clamp(12px,1.2vw,18px)}.scaleCommandHero,.scaleEmailCard,.scaleCard{border-radius:24px}.scaleCommandHero{background:radial-gradient(580px 240px at 15% 0%,rgba(34,211,238,.16),transparent 62%),linear-gradient(135deg,rgba(255,255,255,.98),rgba(240,253,250,.76))}.scaleMiniStats{grid-template-columns:repeat(5,minmax(0,1fr))}.scaleMiniStats div,.benchmarkRow,.leakItem,.actionCard,.alertItem,.ruleList div,.emailLiveGrid div{border-radius:16px}
.grid{grid-template-columns:minmax(0,1.72fr) minmax(360px,.72fr);gap:16px}.tableWrap{-webkit-overflow-scrolling:touch;scrollbar-width:thin}.tableWrap::-webkit-scrollbar{height:10px;width:10px}.tableWrap::-webkit-scrollbar-track{background:rgba(15,23,42,.04);border-radius:999px}.tableWrap::-webkit-scrollbar-thumb{background:rgba(15,23,42,.16);border-radius:999px}.jobsTable{min-width:980px}.jobsTable th{position:sticky;top:0;z-index:3}.jobsTable tbody tr{transition:background .14s ease}.jobsTable tbody tr:hover{background:rgba(248,250,252,.74)}.jobsTable th,.jobsTable td{padding:15px 16px}.sideStack{gap:16px}.reportPreviewItem,.reportsTable tbody tr{transition:transform .14s ease,box-shadow .14s ease,background .14s ease}.reportInfoTag,.reportMiniStats span{white-space:nowrap}.reportActions{flex-shrink:0}.reportsManagerBody,.highRiskHeroBody{padding:clamp(18px,1.6vw,28px)}.reportsManagerTitle,.highRiskTitle{font-size:clamp(28px,2.25vw,42px)}.reportsTable{min-width:1100px}.reportNameWrap{min-width:260px}.reportIdText{word-break:break-word}.jobStats{grid-template-columns:repeat(6,minmax(0,1fr))}.jobPage{gap:16px}.jobDetailPad{-webkit-overflow-scrolling:touch}.jobTable{min-width:1380px}.jobTable th{z-index:4}.cellEdit{min-height:46px}.supportGrid{gap:16px}.comparisonGrid{grid-template-columns:minmax(230px,.82fr) minmax(260px,.9fr) minmax(540px,1.55fr)}.driverGrid{gap:14px}
@media(hover:none){.kpi:hover,.stat:hover,.chartCard:hover,.scaleCard:hover,.item:hover{transform:none;box-shadow:var(--dc-soft-shadow)!important}}
@media(max-width:1600px){:root{--dc-shell-max:1480px;--dc-shell-pad:clamp(14px,2.4vw,34px)}.kpis{grid-template-columns:repeat(3,minmax(0,1fr))}.scaleMiniStats{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media(max-width:1280px){:root{--dc-shell-max:1180px}.grid{grid-template-columns:1fr}.sideStack{display:grid;grid-template-columns:1fr 1fr}.sideStack .panel:first-child{grid-column:1/-1}.heroBody,.jobHeroBody{grid-template-columns:1fr}.charts,.jobCharts{grid-template-columns:1fr}.chartCard.wide{grid-column:auto}.scaleCommandGrid{grid-template-columns:1fr}.scaleCommandHero{grid-column:auto}.scaleGridPremiumV2,.scaleGrid{grid-template-columns:1fr 1fr}.wideScaleCard,.alertsExplainerCard{grid-column:1/-1}.benchmarkGridV2{grid-template-columns:1fr 1fr}.comparisonGrid{grid-template-columns:1fr 1fr}.comparisonTableWrap{grid-column:1/-1}.driverGrid{grid-template-columns:1fr 1fr}.jobStats{grid-template-columns:repeat(3,minmax(0,1fr))}.gridMix{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:920px){:root{--dc-shell-pad:clamp(14px,4vw,28px)}.dc-bg{padding-top:30px}.topbar{align-items:flex-start}.statusRow{width:100%;justify-content:flex-start}.rangeWrap,.marginTargetTopWrap{align-items:flex-start;flex-direction:column}.rangeRight,.rangeButtons,.marginTargetTopControls{width:100%;justify-content:flex-start}.rangeBtn{flex:1 1 auto;text-align:center;justify-content:center}.customDates{width:100%;display:grid;grid-template-columns:1fr 1fr auto}.customDates input{width:100%;min-width:0}.kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.creditKpiGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.scaleGridPremiumV2,.scaleGrid,.benchmarkGridV2,.scaleMiniStats{grid-template-columns:1fr}.scaleHeadRight{justify-content:flex-start}.scaleControlHead,.responsiveHead,.jobAnalysisHeader,.scaleCardHeaderRow{flex-direction:column;align-items:flex-start}.sideStack{display:flex}.tableTools,.reportManagerTools{width:100%;display:grid;grid-template-columns:1fr 1fr}.tableTools .searchInput,.reportManagerTools .searchInput{grid-column:1/-1}.searchInput,.selectInput{width:100%;min-width:0}.reportsManagerBody,.highRiskHeroBody{grid-template-columns:1fr}.reportsSummaryCard{max-width:none}.comparisonGrid,.driverGrid,.supportGrid{grid-template-columns:1fr}.sectionSubtle{text-align:left}}
@media(max-width:640px){:root{--dc-shell-pad:24px}.wrap{width:calc(100vw - 24px)}.dc-bg{padding-top:22px;padding-bottom:24px}.pageTitle{font-size:34px;line-height:1.02}.pageSub{font-size:15px}.pageKicker{font-size:11px}.statusRow{display:grid;grid-template-columns:1fr 1fr;width:100%}.statusRow .pill,.statusRow .btn,.statusRow a.btn{justify-content:center;width:100%}.rangeButtons{display:grid;grid-template-columns:1fr 1fr;width:100%}.rangeBtn{width:100%}.customDates{grid-template-columns:1fr}.kpis,.creditKpiGrid,.jobStats,.gridMix{grid-template-columns:1fr}.heroBody,.jobHeroBody{padding:16px}.heroTitle,.jobHeroTitle{font-size:27px}.summaryCard,.jobSummaryCard{padding:14px}.panel,.hero,.jobHero,.scalePanel,.chartCard{border-radius:20px}.panelHead{padding:15px}.panelTitle{font-size:18px}.panelSub{font-size:13px}.chartCard canvas{min-height:190px}.tableTools,.reportManagerTools{grid-template-columns:1fr}.reportsBulkActions{display:grid;grid-template-columns:1fr;width:100%}.reportsBulkActions .btn{justify-content:center;width:100%}.crumbs{gap:8px;padding:11px}.crumbBtn{width:100%;justify-content:center;margin-left:0!important}.buttonRow{display:grid;grid-template-columns:1fr;width:100%}.buttonRow .btn{justify-content:center;width:100%}.emailLiveGrid{grid-template-columns:1fr}.upgradeModal{border-radius:22px;padding:20px}.upgradeTitle{font-size:23px}}
@media(max-width:390px){:root{--dc-shell-pad:18px}.wrap{width:calc(100vw - 18px)}.pageTitle{font-size:30px}.statusRow,.rangeButtons{grid-template-columns:1fr}.kValue,.statValue{font-size:22px}.jobsTable th,.jobsTable td{padding:12px 13px}}
`;
