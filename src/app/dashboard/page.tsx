...
/* DropClarity dashboard polish pass: calmer desktop spacing + bulletproof responsive layout */
.dc-bg *{box-sizing:border-box}
.dc-bg{overflow-x:hidden!important;background:linear-gradient(180deg,#f8fbff 0%,#f6f3ff 42%,#ffffff 100%)!important}
.dc-bg .wrap{max-width:1280px!important;margin:0 auto!important;padding-inline:clamp(16px,2.4vw,32px)!important;padding-bottom:clamp(42px,6vw,86px)!important}
.dc-bg .panel,.dc-bg .chartCard,.dc-bg .scalePanel,.dc-bg .creditKpiPanel,.dc-bg .profitSnapshot,.dc-bg .topbar,.dc-bg .rangeWrap,.dc-bg .jobHero,.dc-bg .cleanModeShell{box-shadow:0 16px 48px rgba(15,23,42,.055)!important;border:1px solid rgba(148,163,184,.22)!important}
.dc-bg .panel,.dc-bg .chartCard,.dc-bg .scalePanel,.dc-bg .creditKpiPanel,.dc-bg .profitSnapshot{margin-top:clamp(16px,2.1vw,26px)!important}
.dc-bg .panelHead,.dc-bg .chartHead,.dc-bg .creditKpiHead{padding:clamp(18px,2vw,24px)!important;gap:18px!important}
.dc-bg .pad{padding:clamp(18px,2vw,24px)!important}
.dc-bg .panelTitle,.dc-bg .chartTitle,.dc-bg .creditKpiTitle{letter-spacing:-.025em!important;line-height:1.15!important}
.dc-bg .panelSub,.dc-bg .chartSub,.dc-bg .creditKpiSub,.dc-bg .itemMeta,.dc-bg .jobMeta{line-height:1.45!important;max-width:72ch}

/* Header controls: less cramped on desktop and mobile */
.dc-bg .topbar{display:grid!important;grid-template-columns:minmax(0,1.15fr) minmax(320px,.85fr)!important;align-items:start!important;gap:clamp(18px,3vw,34px)!important;padding:clamp(20px,3vw,34px)!important}
.dc-bg .topbarRight,.dc-bg .internalUtilityRight,.dc-bg .internalQuickActions{display:grid!important;gap:12px!important;justify-items:end!important}
.dc-bg .statusRow{gap:9px!important;flex-wrap:wrap!important;justify-content:flex-end!important}
.dc-bg .pageTitle{max-width:760px!important;line-height:1.03!important}
.dc-bg .pageSub{max-width:720px!important}
.dc-bg .marginTargetTopWrap{max-width:440px!important;width:100%!important;padding:12px 14px!important;border-radius:18px!important;background:rgba(255,255,255,.72)!important}
.dc-bg .rangeWrap{display:grid!important;grid-template-columns:minmax(180px,.38fr) minmax(0,1fr)!important;align-items:start!important;gap:18px!important;padding:clamp(16px,2vw,22px)!important}
.dc-bg .rangeRight{align-items:flex-start!important;gap:12px!important}
.dc-bg .rangeButtons{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;width:100%!important;max-width:650px!important}
.dc-bg .rangeBtn{white-space:nowrap!important}

/* Top profit snapshot: executive first, secondary details breathe */
.dc-bg .profitSnapshot{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(310px,.74fr)!important;gap:clamp(18px,2.4vw,28px)!important;padding:clamp(22px,3vw,34px)!important;align-items:stretch!important}
.dc-bg .profitSnapshotMain{min-width:0!important;display:flex!important;flex-direction:column!important;gap:14px!important}
.dc-bg .profitSnapshotMetrics{display:grid!important;grid-template-columns:1fr 1fr!important;gap:12px!important;align-content:start!important}
.dc-bg .profitSnapshotMetric{padding:16px!important;border-radius:18px!important;min-height:112px!important}
.dc-bg .profitSnapshotMiniKpis{gap:10px!important;max-width:650px!important}
.dc-bg .profitSnapshotOpportunity{grid-column:1/-1!important;margin-top:0!important;padding:14px 16px!important;border-radius:18px!important;display:grid!important;grid-template-columns:auto minmax(0,1fr) auto!important;gap:12px!important;align-items:center!important;text-align:left!important}

/* KPI and chart rhythm */
.dc-bg .kpis{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:14px!important;padding:0 clamp(18px,2vw,24px) clamp(18px,2vw,24px)!important}
.dc-bg .kpi{min-height:128px!important;padding:18px!important;border-radius:20px!important;display:flex!important;flex-direction:column!important;justify-content:space-between!important}
.dc-bg .kValue{font-size:clamp(23px,2.2vw,34px)!important;line-height:1.05!important;letter-spacing:-.04em!important;word-break:break-word!important}
.dc-bg .charts{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:clamp(16px,2vw,22px)!important;margin-top:clamp(16px,2vw,24px)!important}
.dc-bg .chartCard{min-width:0!important;overflow:hidden!important}
.dc-bg .chartCard canvas{width:100%!important;max-width:100%!important;display:block!important;min-height:220px!important}
.dc-bg .chartCard.wide{grid-column:1/-1!important}
.dc-bg .gridMix{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:14px!important}
.dc-bg .mixRow{padding:15px!important;border-radius:18px!important}

/* Scale section: give the $999 area more room and cleaner hierarchy */
.dc-bg .scalePanel{padding:clamp(18px,2.4vw,28px)!important;border-radius:28px!important}
.dc-bg .scaleControlHead,.dc-bg .premiumScaleHead{padding:0 0 clamp(16px,2vw,22px)!important;margin-bottom:clamp(14px,2vw,22px)!important;border-bottom:1px solid rgba(148,163,184,.18)!important}
.dc-bg .scaleHeadRight{gap:8px!important;align-items:flex-end!important}
.dc-bg .scaleExecutiveGrid{display:grid!important;grid-template-columns:minmax(280px,.95fr) minmax(360px,1.25fr)!important;gap:clamp(16px,2vw,22px)!important;align-items:stretch!important}
.dc-bg .scaleRecoveryCommand{padding:clamp(20px,2.5vw,28px)!important;border-radius:24px!important;min-height:100%!important}
.dc-bg .scaleActionQueueCard,.dc-bg .scaleBenchmarkCard{padding:clamp(18px,2vw,24px)!important;border-radius:24px!important}
.dc-bg .scaleBenchmarkCard{grid-column:1/-1!important}
.dc-bg .scaleBenchmarkRows{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important}
.dc-bg .scaleBenchmarkRow{padding:14px!important;border-radius:16px!important;min-height:78px!important}
.dc-bg .scaleRecoveryStats{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important}
.dc-bg .scaleQueueList{gap:10px!important}
.dc-bg .scaleQueueItem{grid-template-columns:auto minmax(0,1fr) auto!important;gap:13px!important;padding:14px!important;border-radius:18px!important}
.dc-bg .scaleQueueIssue{display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important;overflow:hidden!important;line-height:1.35!important}
.dc-bg .scaleIntelligenceStrip{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(320px,.85fr)!important;gap:clamp(16px,2vw,22px)!important;margin-top:clamp(16px,2vw,22px)!important}
.dc-bg .scaleInsightNarrative,.dc-bg .scaleCostRadar{padding:clamp(18px,2vw,24px)!important;border-radius:22px!important}
.dc-bg .scalePremiumGrid{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;gap:clamp(16px,2vw,22px)!important;margin-top:clamp(16px,2vw,22px)!important}
.dc-bg .premiumEmailCard{grid-row:span 2!important}
.dc-bg .premiumRulesCard{grid-column:2!important}
.dc-bg .premiumLeakRow{padding:14px!important;border-radius:16px!important}
.dc-bg .premiumLeakFix{line-height:1.38!important}
.dc-bg .ruleList{gap:10px!important}

/* Locked Scale preview */
.dc-bg .lockedScaleHero{display:grid!important;grid-template-columns:auto minmax(0,1fr)!important;gap:18px!important;padding:clamp(18px,2vw,26px)!important;border-radius:24px!important}
.dc-bg .lockedFeatureGrid{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:14px!important}
.dc-bg .lockedFeatureCard{padding:16px!important;border-radius:20px!important;min-height:144px!important}

/* Jobs + reports: less table crunch, cleaner cards */
.dc-bg .grid{display:grid!important;grid-template-columns:minmax(0,1.55fr) minmax(320px,.85fr)!important;gap:clamp(18px,2.2vw,26px)!important;align-items:start!important}
.dc-bg .sideStack{gap:clamp(18px,2vw,24px)!important}
.dc-bg .tableTools,.dc-bg .reportManagerTools,.dc-bg .riskSearchControls{display:grid!important;grid-template-columns:auto minmax(180px,1fr) minmax(150px,.55fr)!important;gap:10px!important;align-items:center!important}
.dc-bg .tableWrap{overflow-x:auto!important;-webkit-overflow-scrolling:touch!important;padding-bottom:2px!important}
.dc-bg .jobsTable{min-width:900px!important;border-collapse:separate!important;border-spacing:0 8px!important}
.dc-bg .jobsTable th{padding:8px 12px!important;white-space:nowrap!important}
.dc-bg .jobsTable td{padding:14px 12px!important;background:rgba(255,255,255,.72)!important;vertical-align:middle!important}
.dc-bg .jobsTable tbody tr{box-shadow:0 8px 24px rgba(15,23,42,.035)!important}
.dc-bg .jobsTable td:first-child{border-radius:14px 0 0 14px!important}
.dc-bg .jobsTable td:last-child{border-radius:0 14px 14px 0!important}
.dc-bg .jobRowActions,.dc-bg .reportRowActions{gap:8px!important;justify-content:flex-end!important;white-space:nowrap!important}
.dc-bg .pastReportsPad{padding-top:0!important}
.dc-bg .reportMiniStats{gap:8px!important;margin-bottom:12px!important;flex-wrap:wrap!important}
.dc-bg .premiumReportCard{padding:15px!important;border-radius:20px!important;margin-bottom:12px!important}
.dc-bg .premiumReportTopline{gap:14px!important;align-items:flex-start!important}
.dc-bg .premiumReportIdentity{min-width:0!important}
.dc-bg .premiumReportName{line-height:1.2!important}
.dc-bg .premiumReportMeta{line-height:1.35!important}
.dc-bg .premiumReportProfitBlock{gap:9px!important;align-items:flex-end!important}
.dc-bg .premiumReportMetrics{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important;margin-top:12px!important}
.dc-bg .premiumReportMetrics>div{padding:10px!important;border-radius:14px!important;background:rgba(248,250,252,.78)!important}
.dc-bg .insightCard{padding:15px!important;border-radius:18px!important;margin-bottom:12px!important}
.dc-bg .insightTop{gap:12px!important;align-items:flex-start!important}
.dc-bg .insightDetail,.dc-bg .insightRecommendation p{line-height:1.42!important}

/* Job detail / all jobs edit view: keep spreadsheet power without visual squeeze */
.dc-bg .jobStats{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:14px!important}
.dc-bg .stat{padding:16px!important;border-radius:18px!important;min-height:116px!important}
.dc-bg .jobDetailPad{overflow-x:auto!important;-webkit-overflow-scrolling:touch!important}
.dc-bg .jobTable{min-width:1180px!important;border-spacing:0 8px!important;border-collapse:separate!important}
.dc-bg .jobTable th{padding:8px 10px!important;white-space:nowrap!important}
.dc-bg .jobTable td{padding:10px!important;background:rgba(255,255,255,.72)!important;vertical-align:top!important}
.dc-bg .jobTable td:first-child{border-radius:14px 0 0 14px!important}
.dc-bg .jobTable td:last-child{border-radius:0 14px 14px 0!important}
.dc-bg .cellEdit{min-height:40px!important;border-radius:12px!important}
.dc-bg .cellHint{margin-top:5px!important;line-height:1.25!important}
.dc-bg .buttonRow{gap:9px!important;align-items:center!important;justify-content:flex-end!important;flex-wrap:wrap!important}
.dc-bg .stackedJobActions{padding:14px 16px!important;border-bottom:1px solid rgba(148,163,184,.14)!important}
.dc-bg .allJobsStack{gap:18px!important}
.dc-bg .allJobsStackItem{border-radius:22px!important;overflow:hidden!important;margin-bottom:4px!important;box-shadow:0 12px 34px rgba(15,23,42,.045)!important}
.dc-bg .allJobsStackItemHead{padding:16px!important;gap:14px!important}
.dc-bg .compactJobStackHeader{align-items:center!important}
.dc-bg .allJobsSubtotalPad{padding-top:0!important}

/* High-risk queue: card layout breathes */
.dc-bg .riskCommandHero{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(280px,.72fr)!important;gap:18px!important;padding:clamp(18px,2vw,24px)!important}
.dc-bg .riskSummaryGrid{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:12px!important}
.dc-bg .riskSummaryCard{padding:16px!important;border-radius:18px!important;min-height:118px!important}
.dc-bg .riskQueueList{display:grid!important;gap:14px!important;padding:clamp(14px,1.8vw,20px)!important}
.dc-bg .riskQueueCard{display:grid!important;grid-template-columns:auto minmax(0,1fr) 160px!important;gap:16px!important;padding:16px!important;border-radius:20px!important}
.dc-bg .riskMetricGrid{grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:10px!important}
.dc-bg .riskMetricGrid>div{padding:12px!important;border-radius:14px!important}
.dc-bg .riskActions{display:grid!important;grid-template-columns:1fr!important;gap:8px!important;align-content:start!important}
.dc-bg .riskActions .btn{width:100%!important;justify-content:center!important}
.dc-bg .riskInsightBox{line-height:1.42!important}

/* Reports manager */
.dc-bg .reportsManagerBody{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(300px,.65fr)!important;gap:18px!important;padding:clamp(18px,2vw,24px)!important}
.dc-bg .reportsBulkActions{display:flex!important;gap:10px!important;flex-wrap:wrap!important;padding:0 clamp(18px,2vw,24px) clamp(10px,1.6vw,16px)!important}
.dc-bg .reportsSummaryCard{border-radius:20px!important;padding:16px!important}

/* Tablet */
@media(max-width:1100px){
  .dc-bg .topbar,.dc-bg .rangeWrap,.dc-bg .profitSnapshot,.dc-bg .grid,.dc-bg .scaleExecutiveGrid,.dc-bg .scaleIntelligenceStrip,.dc-bg .scalePremiumGrid,.dc-bg .riskCommandHero,.dc-bg .reportsManagerBody{grid-template-columns:1fr!important}
  .dc-bg .topbarRight,.dc-bg .internalUtilityRight,.dc-bg .internalQuickActions{justify-items:stretch!important}
  .dc-bg .statusRow{justify-content:flex-start!important}
  .dc-bg .marginTargetTopWrap{max-width:none!important}
  .dc-bg .rangeButtons{max-width:none!important}
  .dc-bg .kpis,.dc-bg .jobStats{grid-template-columns:repeat(2,minmax(0,1fr))!important}
  .dc-bg .charts{grid-template-columns:1fr!important}
  .dc-bg .scaleBenchmarkRows,.dc-bg .gridMix{grid-template-columns:1fr!important}
  .dc-bg .premiumEmailCard,.dc-bg .premiumRulesCard{grid-column:auto!important;grid-row:auto!important}
  .dc-bg .lockedFeatureGrid{grid-template-columns:1fr!important}
  .dc-bg .riskSummaryGrid,.dc-bg .riskMetricGrid{grid-template-columns:repeat(2,minmax(0,1fr))!important}
  .dc-bg .riskQueueCard{grid-template-columns:1fr!important}
  .dc-bg .riskActions{grid-template-columns:repeat(2,minmax(0,1fr)) auto!important}
}

/* Phone */
@media(max-width:720px){
  .dc-bg .wrap{padding-inline:12px!important;padding-bottom:40px!important}
  .dc-bg .topbar,.dc-bg .rangeWrap,.dc-bg .profitSnapshot,.dc-bg .panel,.dc-bg .chartCard,.dc-bg .scalePanel,.dc-bg .creditKpiPanel,.dc-bg .jobHero,.dc-bg .cleanModeShell{border-radius:20px!important}
  .dc-bg .topbar{padding:18px!important;gap:14px!important}
  .dc-bg .pageTitle{font-size:clamp(28px,9vw,36px)!important;line-height:1.08!important}
  .dc-bg .pageSub{font-size:13.5px!important;line-height:1.45!important}
  .dc-bg .statusRow{display:grid!important;grid-template-columns:1fr 1fr!important;width:100%!important;gap:8px!important}
  .dc-bg .statusRow .pill,.dc-bg .statusRow .btn{width:100%!important;justify-content:center!important;min-width:0!important}
  .dc-bg .marginTargetTopWrap{grid-template-columns:1fr!important;padding:12px!important}
  .dc-bg .marginTargetTopControls{display:grid!important;grid-template-columns:1fr auto!important;gap:8px!important;width:100%!important}
  .dc-bg .compactTargetInputGroup{width:100%!important;justify-content:center!important}
  .dc-bg .rangeButtons{grid-template-columns:repeat(2,minmax(0,1fr))!important}
  .dc-bg .rangeRight,.dc-bg .customDates{display:grid!important;grid-template-columns:1fr!important;width:100%!important}
  .dc-bg .customDates input,.dc-bg .customDates .btn,.dc-bg .rangeRight>.btn{width:100%!important;justify-content:center!important}
  .dc-bg .panelHead,.dc-bg .chartHead,.dc-bg .responsiveHead,.dc-bg .modeContextHeader,.dc-bg .allJobsStackItemHead{display:grid!important;grid-template-columns:1fr!important;align-items:stretch!important;gap:12px!important}
  .dc-bg .pad,.dc-bg .panelHead,.dc-bg .chartHead,.dc-bg .creditKpiHead{padding:14px!important}
  .dc-bg .kpis,.dc-bg .jobStats,.dc-bg .profitSnapshotMetrics,.dc-bg .scaleRecoveryStats,.dc-bg .riskSummaryGrid,.dc-bg .riskMetricGrid,.dc-bg .creditKpiGrid,.dc-bg .premiumReportMetrics,.dc-bg .emailLiveGrid{grid-template-columns:1fr!important}
  .dc-bg .kpi,.dc-bg .stat,.dc-bg .profitSnapshotMetric,.dc-bg .riskSummaryCard{min-height:0!important;padding:14px!important}
  .dc-bg .profitSnapshot{padding:16px!important}
  .dc-bg .profitSnapshotTitle{font-size:clamp(24px,7vw,30px)!important}
  .dc-bg .profitSnapshotOpportunity{grid-template-columns:1fr!important;gap:5px!important}
  .dc-bg .tableTools,.dc-bg .reportManagerTools,.dc-bg .riskSearchControls{grid-template-columns:1fr!important;width:100%!important}
  .dc-bg .tableTools .btn,.dc-bg .tableTools input,.dc-bg .tableTools select,.dc-bg .reportManagerTools .btn,.dc-bg .reportManagerTools input,.dc-bg .reportManagerTools select,.dc-bg .riskSearchControls input,.dc-bg .riskSearchControls select{width:100%!important;justify-content:center!important}
  .dc-bg .premiumReportTopline,.dc-bg .premiumLeakTop,.dc-bg .emailCardTop{display:grid!important;grid-template-columns:1fr!important;gap:10px!important}
  .dc-bg .premiumReportProfitBlock{display:grid!important;grid-template-columns:1fr auto!important;align-items:center!important;width:100%!important}
  .dc-bg .premiumReportProfit{justify-self:start!important}
  .dc-bg .scaleQueueItem,.dc-bg .wowActionItem{grid-template-columns:1fr!important;text-align:left!important}
  .dc-bg .scaleQueueRank,.dc-bg .scaleQueueImpact,.dc-bg .wowActionRank,.dc-bg .wowActionImpact{justify-self:start!important}
  .dc-bg .scaleRecoveryValue,.dc-bg .wowRecoveryValue,.dc-bg .kValue,.dc-bg .statValue{font-size:clamp(22px,7vw,28px)!important}
  .dc-bg .scalePanel{padding:14px!important}
  .dc-bg .scaleRecoveryCommand,.dc-bg .scaleActionQueueCard,.dc-bg .scaleBenchmarkCard,.dc-bg .scaleInsightNarrative,.dc-bg .scaleCostRadar,.dc-bg .scaleCard,.dc-bg .lockedScaleHero{padding:14px!important;border-radius:18px!important}
  .dc-bg .lockedScaleHero{grid-template-columns:1fr!important}
  .dc-bg .lockedScaleIcon{display:none!important}
  .dc-bg .lockedScaleActions,.dc-bg .emailEditActions,.dc-bg .profitSnapshotActions,.dc-bg .wowActions,.dc-bg .reportsBulkActions{display:grid!important;grid-template-columns:1fr!important;width:100%!important}
  .dc-bg .lockedScaleActions .btn,.dc-bg .emailEditActions .btn,.dc-bg .profitSnapshotActions .btn,.dc-bg .wowActions .btn,.dc-bg .reportsBulkActions .btn{width:100%!important;justify-content:center!important}
  .dc-bg .riskActions{grid-template-columns:1fr!important}
  .dc-bg .riskActions .lowkeyHideJobBtn{justify-self:center!important}
  .dc-bg .modeHeaderActions{display:grid!important;grid-template-columns:1fr!important;width:100%!important;gap:8px!important}
  .dc-bg .modeCount,.dc-bg .modeHeaderActions .crumbBtn{width:100%!important;justify-content:center!important}
  .dc-bg .buttonRow,.dc-bg .stackedJobActions .buttonRow{display:grid!important;grid-template-columns:1fr!important;width:100%!important}
  .dc-bg .buttonRow .btn,.dc-bg .stackedJobActions .btn{width:100%!important;justify-content:center!important}
  .dc-bg .allJobsStackItemHead .jobRowActions,.dc-bg .stackedHeaderActions{display:grid!important;grid-template-columns:auto 1fr!important;width:100%!important;gap:8px!important}
  .dc-bg .compactFullViewBtn{width:100%!important;justify-content:center!important}
  .dc-bg .jobTable{min-width:1040px!important}
  .dc-bg .jobsTable{min-width:820px!important}
}

@media(max-width:420px){
  .dc-bg .wrap{padding-inline:10px!important}
  .dc-bg .statusRow{grid-template-columns:1fr!important}
  .dc-bg .rangeButtons{grid-template-columns:1fr!important}
  .dc-bg .pageTitle{font-size:28px!important}
  .dc-bg .premiumReportProfitBlock{grid-template-columns:1fr!important}
  .dc-bg .premiumReportHideBtn,.dc-bg .reportViewBtn{justify-self:start!important}
}
