  ...
  {onHideJob ? (
    <button className="lowkeyHideJobBtn inlineHideJobBtn" type="button" onClick={() => onHideJob(base, jobKey)} title="Hide this job from dashboard totals" aria-label="Hide this job from dashboard totals">×</button>
          ...
          <div className="pad jobDetailPad">
            <table className="jobTable" style={{ minWidth: `${1320 + Math.max(0, job.custom_categories.length) * 172}px` }}>
              <thead>
                <tr>
...
/* Final launch polish: readable Scale cards, calmer recoverable value, and cleaner custom category headers. */
...
main.dc-bg .inlineCustomRemove:focus-visible{
