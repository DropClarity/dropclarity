...
/* Responsive spacing polish patch: date range, past reports, and editable job detail */
.dc-bg .rangeWrap{
...
.dc-bg .rangeRight > .btn,
.dc-bg .rangeRight > a.btn{
  white-space:nowrap!important;
}

/* Past reports needs more breathing room in the dashboard side column */
.dc-bg .pastReportsPanel{
  overflow:hidden!important;
}
.dc-bg .pastReportsHead{
  gap:16px!important;
  padding:18px 18px 16px!important;
}
.dc-bg .pastReportsPad{
  padding:18px!important;
}
.dc-bg .premiumReportStats{
  gap:10px!important;
  margin-bottom:14px!important;
}
.dc-bg .premiumReportStats span{
  min-height:38px!important;
  display:flex!important;
  align-items:center!important;
...
.dc-bg .premiumReportIdentity{
  min-width:0!important;
  flex:1 1 auto!important;
}
.dc-bg .premiumReportProfitBlock{
  gap:10px!important;
  flex-wrap:nowrap!important;
}
.dc-bg .premiumReportTagRow{
  margin-top:12px!important;
  gap:8px!important;
}
...
.dc-bg .premiumReportMetrics div{
  min-height:54px!important;
  padding:10px!important;
}
.dc-bg .premiumReportMetrics strong{
  display:block!important;
...
/* Editable job detail: make the action row and editable buckets feel less packed */
.dc-bg .jobDetailFocus .panelHead{
  gap:16px!important;
  align-items:flex-start!important;
}
.dc-bg .jobDetailFocus .buttonRow,
.dc-bg .stackedJobActions .buttonRow{
  gap:10px!important;
  flex-wrap:wrap!important;
  justify-content:flex-end!important;
}
.dc-bg .jobDetailFocus .buttonRow .btn,
.dc-bg .stackedJobActions .buttonRow .btn{
...
.dc-bg .jobTable th:nth-child(1),
.dc-bg .jobTable td:nth-child(1),
.dc-bg .jobTable th:nth-child(2),
.dc-bg .jobTable td:nth-child(2){
  min-width:138px!important;
}
.dc-bg .jobTable th:nth-child(4),
.dc-bg .jobTable td:nth-child(4){
  min-width:150px!important;
}
.dc-bg .jobTable th:nth-child(n+6),
.dc-bg .jobTable td:nth-child(n+6){
...
@media(max-width:560px){
  ...
  .dc-bg .rangeButtons .rangeBtn:first-child{
  ...
  .dc-bg .customDates input,
  .dc-bg .customDates .btn{
    width:100%!important;
  }
  .dc-bg .pastReportsHead,
  .dc-bg .pastReportsPad{
