        ...
        <div className="mx-auto w-full max-w-[1600px]">
          ...
          <div className="mt-10 xl:hidden">
            <div className="mx-auto flex max-w-[760px] items-center justify-between gap-3">
              ...
              <div className="min-w-0 flex-1 overflow-hidden px-0 sm:px-1">
                <div
                ...
                >
                  {pricing.map((plan) => (
                    ...
                    >
                      <article
                        className={`relative mx-auto flex min-h-[540px] max-w-[350px] flex-col rounded-[24px] border bg-white p-5 shadow-[0_18px_60px_rgba(2,6,23,.08)] transition sm:min-h-[560px] sm:max-w-[460px] sm:rounded-[28px] sm:p-6 md:max-w-[560px] md:p-7 ${
                          plan.featured
                      ...
                      >
                        {plan.featured ? (
                          <div className="absolute left-5 right-5 top-0 -translate-y-1/2 rounded-full bg-violet-500 px-4 py-2 text-center text-[11px] font-black text-white shadow-lg shadow-violet-200 sm:left-7 sm:right-7 sm:text-xs">
          ...
          <div className="mt-10 hidden gap-6 xl:grid xl:grid-cols-3">
            {pricing.map((plan) => (
              <article
                key={plan.name}
                className={`relative flex min-h-[610px] flex-col rounded-[28px] border bg-white p-8 shadow-[0_18px_60px_rgba(2,6,23,.08)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_70px_rgba(2,6,23,.11)] ${
                  plan.featured
                    ? "border-violet-400 ring-2 ring-violet-200"
                    : "border-slate-200"
                }`}
