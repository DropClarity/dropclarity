    ...
    <div className="scalePanel premiumScalePanel">
      ...
      <div className="scaleCommandGrid">
        ...
        <div className="scaleEmailCard">
          ...
          <button
            className={emailAlertsEnabled ? "emailTextButton" : "btn btn-primary emailEnableButton"}
            type="button"
...
.emailTextButton{
  ...
  font-weight:900;
  cursor:pointer;
  transition:color .14s ease,text-decoration-color .14s ease,transform .08s ease;
  text-decoration:underline;
  text-decoration-color:transparent;
  text-underline-offset:4px;
}
.emailTextButton:hover{
  color:rgba(15,23,42,.88);
  text-decoration-color:rgba(15,23,42,.34);
