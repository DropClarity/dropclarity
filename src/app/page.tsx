  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white text-slate-950 [font-family:ui-sans-serif,system-ui,-apple-system,Segoe_UI,Roboto,Arial]">
      <section className="relative overflow-hidden border-b border-slate-100">
        ...
        <div className="relative mx-auto grid w-full max-w-[1760px] items-center gap-10 px-5 py-12 sm:px-8 sm:py-14 lg:grid-cols-[0.86fr_1.14fr] lg:px-10 lg:py-18 xl:gap-16 2xl:py-20">
