...
/* Desktop / large-screen width refinement only.
   Keeps tablet and mobile breakpoints unchanged while letting the dashboard breathe on wider monitors. */
@media (min-width:1200px){
  .dc-bg .wrap{
    width:min(2440px,calc(100vw - 20px))!important;
    max-width:2440px!important;
  }
}
@media (min-width:1800px){
  .dc-bg .wrap{
    width:min(2720px,calc(100vw - 24px))!important;
